...
class Game(object):
    ...
    def display_iu(self, record):
        ...
        pygame.draw.rect(self.display_juego, (200, 200, 200), (0, self.alto_juego, self.ancho_juego, 0))
...
class Player(object):
    def __init__(self):
        self.x = 100
        self.y = 100
        self.posicion = [] #guarda todas las posiciones de la cola 
    ...
    def display_jugador(self, x, y, game):
        ...
        if game.colision == False:
            '''con esto se recrea el efecto de movimiento de la serpiente'''
